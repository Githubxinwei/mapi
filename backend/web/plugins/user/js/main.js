...
function submitEvent()
{
	...
	//closeWindow();
	close();
	console.log($('#imgBoolBlock').css('display'))
	if( $("#imgBoolBlock").css("display") == undefined ){

		$("#imgBoolFalse").removeClass("imgBoolFalse")
		$("#imgBoolUndefined").removeClass("imgBoolTrue")

		$("#imgBoolFalse").addClass("imgBoolTrue")
		$("#imgBoolUndefined").addClass("imgBoolFalse")
	}
	if( $("#imgBoolBlock").css("display")!= undefined ){
		// $("#imgBoolFalse").removeClass("imgBoolFalse")
		// $("#imgBoolUndefined").removeClass("imgBoolTrue")
